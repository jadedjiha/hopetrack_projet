<x-guest-layout>
    ...
    <!-- Titre -->
    <div class="mb-8">
        <h2 class="text-3xl font-black text-gray-900">Créer un compte</h2>
        <p class="text-gray-500 mt-2 text-sm">Rejoignez HopeTrack et gérez votre équipe</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-4">
        ...
        <!-- Bouton -->
        <button type="submit"
            class="w-full py-3.5 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-semibold rounded-2xl transition-all duration-200 shadow-lg hover:shadow-xl text-sm mt-2">
            Créer mon compte →
        </button>
    ...
    <p class="mt-6 text-center text-sm text-gray-500">
        Déjà un compte ?
        <a href="{{ route('login') }}" class="text-indigo-600 hover:text-indigo-700 font-semibold ml-1 transition">
            Se connecter
        </a>
    </p>
